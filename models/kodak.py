...
class Kodak:
    ...
    def fetch_questions(self, num_questions, category, difficulty, timer, trivia_data, game_id, username, db):
        ...
        Game(game_id, trivia_data.get('questions'), trivia_data.get('answers'), trivia_data.get('correct_answers'), 0, timer, db).create_game()
